...
DNA input files:
	...
	(2) The output generated by Varscan, which includes both germline and somatic variants through -v;

	(3) Two Defined files: one contains germline variants through -g and the other contains somatic mutations through -s.
